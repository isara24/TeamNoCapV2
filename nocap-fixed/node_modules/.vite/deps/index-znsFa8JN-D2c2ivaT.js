//#region node_modules/@tanstack/router-devtools-core/dist/index-znsFa8JN.js
var sharedConfig = {
	context: void 0,
	registry: void 0,
	effects: void 0,
...
function createSignal(value, options) {
	...
	const setter = (value2) => {
		if (typeof value2 === "function") value2 = value2(s.value);
	...
	mount(el) {
		...
		const dispose2 = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-DLsVEFsK-B7LRAPVD.js"));
...
var TanStackRouterDevtoolsPanelCore = class {
	...
	#Component;
	constructor(config) {
		const { router, routerState, shadowDOMTarget, setIsOpen, style: style2, className: className2 } = config;
	...
	mount(el) {
		...
		const dispose2 = render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-DYX5cXun-KZ0cPl1Q.js").then((n) => n.c));
...
//#endregion
export { setAttribute as C, useContext as D, untrack as E, useDevtoolsOnClose as O, onCleanup as S, template as T, createUniqueId as _, ShadowDomTargetContext as a, memo as b, TanStackRouterDevtoolsCore as c, className as d, createComponent as f, createSignal as g, createRenderEffect as h, Match as i, TanStackRouterDevtoolsPanelCore as l, createMemo as m, Dynamic as n, Show as o, createEffect as p, For as r, Switch as s, DevtoolsOnCloseContext as t, addEventListener as u, delegateEvents as v, spread as w, mergeProps as x, insert as y };
//# sourceMappingURL=index-znsFa8JN-D2c2ivaT.js.map